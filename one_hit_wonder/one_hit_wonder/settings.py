"""
Django settings for one_hit_wonder project.
...
SECRET_KEY = 's+)g97)zath=^ujn4_=-07vtza=lq&$&eq#crn$f@56!3b($y%'
...
ROOT_URLCONF = 'one_hit_wonder.urls'
...
WSGI_APPLICATION = 'one_hit_wonder.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': os.path.join(BASE_DIR, 'mariadb.cnf'),
        },
    }
}
